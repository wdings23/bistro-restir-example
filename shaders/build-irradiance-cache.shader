...
) -> UpdateIrradianceCacheResult
{
    ...
    //intersectionInfo = intersectBVHFirstHit(ray);
    intersectionInfo = intersectBVH3(ray, 0u);
    ...
    triPt2: vec3<f32>) -> RayTriangleIntersectionResult
{
    ...
    var bCond1: bool = (fT >= -0.00001f && fT <= 1.00001f);
    if(bCond1)
    {
        collisionPtOnTriangle = (triPt0 * baryCentricCoord.x + triPt1 * baryCentricCoord.y + triPt2 * baryCentricCoord.z);
    }

    ret.mBarycentricCoordinate = baryCentricCoord.xyz;
    ret.mIntersectPosition = collisionPtOnTriangle.xyz;
...
//fn intersectTri(
//    ray: Ray,
//    iTriangle: u32) -> RayTriangleIntersectionResult
//{
...
//
///////
//fn intersectBVHFirstHit(
//    ray: Ray) -> IntersectBVHResult
//{
...
//                let intersectionInfo: RayTriangleIntersectionResult = intersectTri(
//                    ray,
//                    iTriangleIndex);
//                
//                if(abs(intersectionInfo.mIntersectPosition.x) < 1000.0f)
//                {
//                    // hit
//                    ret.mHitPosition = intersectionInfo.mIntersectPosition.xyz;
//                    ret.mHitNormal = intersectionInfo.mIntersectNormal.xyz;
//                    ret.miHitTriangle = iTriangleIndex;
//                }
//            }
//
//            if(ret.miHitTriangle != UINT32_MAX)
//            {
//                break;
//            }
//        }
...
//                if(abs(intersectionInfo.mIntersectPosition.x) < 1000.0f)
//                {
//                    let fDistanceToHitPosition: f32 = length(intersectionInfo.mIntersectPosition.xyz - ray.mOrigin.xyz);
//                    if(fDistanceToHitPosition < fClosestDistance)
//                    {
//                        fClosestDistance = fDistanceToHitPosition;
//                        ret.mHitPosition = intersectionInfo.mIntersectPosition.xyz;
//                        ret.mHitNormal = intersectionInfo.mIntersectNormal.xyz;
//                        ret.miHitTriangle = iTriangleIndex;
//                    }
